...
async def _get_candle_direction(qx_client: Quotex, asset_name: str, candle_size: int, account_doc_id: str, risk_mode: str = "SAFE") -> Tuple[Optional[str], str, Optional[int]]:
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"[{asset_name}] Candle fetch timed out (10.0s limit). Checking connection status...")
            is_connected = False
            try:
        ...
        if candles and isinstance(candles, list) and len(candles) > 0:
            ...
            if signal in ['call', 'put'] and confidence >= 85:
                 ...
                 try:
                      ...
                      if status:
                           ...
                           if 'trade_history_db' in globals() and trade_history_db is not None:
                               ...
                               trade_record = {
                                   "account_doc_id": str(account_doc_id),
                                   "account_mode": str(settings.get("account_mode", "PRACTICE")),
